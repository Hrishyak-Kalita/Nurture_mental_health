...
const Emergency = ({ title }) => {
    return (
        ...
        <div className='Emer'>
            ...
            <Avatar size={150} src="https://res.cloudinary.com/dttau3ddh/image/upload/v1708417639/a-female-therapist-sitting-in-her-chamber-alone-in-upscaled_1_1_dbml6d.jpg" />
            </div>
